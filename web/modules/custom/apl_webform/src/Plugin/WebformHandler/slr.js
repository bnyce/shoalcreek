...
$.getJSON("/roles.json?t=" + Date.now(), function(json9) {
  ...
  for (k = 0; k < json9.length; k++) {
    ...
    my_roles.push(j_roles);
           if ( j_roles.includes( 'slr_admin' )  || j_roles.includes( 'administrator' ) ) {
...
async         function check_dates(input_date, room_id) {
        ...
        if (ch_date.isAfter(max_date, 'day') && (is_admin < 1)) {
          ...
          if (ch_date.isBefore(min_date)) {
            ...
            check_dates(ch_date2, room_id);
              ...
              if (ch_date.format('d') == '0') { // open at noon on Sunday
                opening_hour = 12;
              } 
  ...
  which_date.change(function(e) {
    if (dayjs(which_date.val()).isValid()) {
      ...
      if ( the_date == '2023-01-16' || the_date == '2023-02-10' || the_date == '2023-02-19' || the_date == '2023-02-20' || the_date == '2023-04-09' || the_date == '2023-05-12' || the_date == '2023-05-28' || the_date == '2023-05-29' || the_date == '2023-06-18' || the_date == '2023-06-19' || the_date == '2023-07-04' || the_date == '2023-08-11' || the_date == '2023-09-03' || the_date == '2023-09-04' || the_date == '2023-10-20' || the_date == '2023-11-10' || the_date == '2023-11-11' || the_date == '2023-11-23' || the_date == '2023-11-24' || the_date == '2023-12-24' || the_date == '2023-12-25' || the_date == '2023-12-26') {  
